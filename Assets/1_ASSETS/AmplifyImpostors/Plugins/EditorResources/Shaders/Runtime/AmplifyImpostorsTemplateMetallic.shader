Shader /*ase_name*/ "Hidden/Impostors/Runtime/[Deprecated] Metallic"/*end*/
{
	Properties
	{
		/*ase_props*/
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag_surf (v2f_surf IN, out float outDepth : SV_Depth /*ase_frag_input*/) : SV_Target {
				...
				fixed3 albedo = /*ase_frag_out:Albedo;Float3;-1;-1;_Albedo*/fixed3(0, 0, 0)/*end*/;
				fixed3 normal = /*ase_frag_out:World Normal;Float3;-1;-1;_Normal*/fixed3(0, 0, 1)/*end*/;
				half3 emission = /*ase_frag_out:Emission;Float3;-1;-1;_Emission*/half3(0, 0, 0)/*end*/;
				half metallic = /*ase_frag_out:Metallic;Float;-1;-1;_Metallic*/0/*end*/;
				half smoothness = /*ase_frag_out:Smoothness;Float;-1;-1;_Smoothness*/0/*end*/;
				half occlusion = /*ase_frag_out:Occlusion;Float;-1;-1;_Occlusion*/1/*end*/;
				fixed alpha = /*ase_frag_out:Alpha;Float;-1;-1;_Alpha*/1/*end*/;
		...
		Pass
		{
			...
			fixed4 frag_surf ( v2f_surf IN, out float outDepth : SV_Depth /*ase_frag_input*/ ) : SV_Target {
				...
				fixed3 normal = /*ase_frag_out:World Normal;Float3;-1;-1;_Normal*/fixed3(0, 0, 1)/*end*/;
				half3 emission = /*ase_frag_out:Emission;Float3;-1;-1;_Emission*/half3(0, 0, 0)/*end*/;
				fixed3 metallic = /*ase_frag_out:Metallic;Float;-1;-1;_Metallic*/fixed3(0, 0, 0)/*end*/;
				half smoothness = /*ase_frag_out:Smoothness;Float;-1;-1;_Smoothness*/0/*end*/;
				half occlusion = /*ase_frag_out:Occlusion;Float;-1;-1;_Occlusion*/1/*end*/;
				fixed alpha = /*ase_frag_out:Alpha;Float;-1;-1;_Alpha*/1/*end*/;
