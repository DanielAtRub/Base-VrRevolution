...
public class JuegoManager0 : NetworkBehaviour
{
    [Header("GLOBALES")]
    ...
    public void manager()
    {
        ...
        if (ActLevel1)
        {
            // ESTO NO DEBERIA REPETIRSE CONTINUAMENTE, SOBRE TODO LOS RPC A LOS CLIENTES, AUNQUE PUEDE SER NECESARIO 
            // PARA QUE CUANDO ENTRE UN NUEVO CLIENTE ADQUIERA LA INFO DEL MOMENTO DE JUEGO (SOLO USAR LOS RPC)
            ...
            if (ActOrda3)
            {
                ...
                //if (Orda3_1.GetComponent<Enemigo>().isDead)
                {
