...
public class InteractiveObjSimple : NetworkBehaviour
{
    [SyncVar]
    ...
    public void Actualiza()
    {
        if (!Activado)
        {
            ...
            if (haveActBehavior)
                ObjBehavior.GetComponent<BehaviourTreeOwner>().enabled = true;
        ...
        else
        {
            ...
            if (haveActBehavior)
                ObjBehavior.GetComponent<BehaviourTreeOwner>().enabled = false;
